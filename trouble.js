let v1 = 3;
let v2 = 4
alert("3 times 4" + '=' + v1 * v2); //non-commented

 // This sets the general styling for the divs within the section tag using .style
            let section = document.getElementById("s1") //Element is  singular
            section.style.width = "50%"
            section.style.textAlign = "center"
            section.style.fontFamily = "arial, serif"
            section.style.fontWeight = "bold" //style mispelled
            ...
            // RED
            const red = document.getElementById("red") //Element not capitalized
            red.innerHTML = "RED"
